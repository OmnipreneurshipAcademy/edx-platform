...
class ExtendedUserProfile(models.Model):
    ...
    saudi_national = models.BooleanField(verbose_name=_('Saudi National'))

    company = models.ForeignKey(BusinessLine, verbose_name=_('Company'), on_delete=models.CASCADE, null=True)
